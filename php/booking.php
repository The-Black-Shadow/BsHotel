...
if (isset($_POST['submit'])) {
    ...
    mysqli_query($conn, "insert into booking values('$_POST[name]', '$_POST[email]', '$_POST[password]', '$check_inn', '$check_outt', '$_POST[adults]', '$_POST[children]', '$_POST[rooms]', '$room_type')");
